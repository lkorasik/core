...
import { GroupScreen } from '../EducationalProgramScreen/GroupScreen';
import { EditEducationalProgramScreen } from '../EducationalProgramScreen/EditEducationalProgramScreen';
