...
create table students (educational_program_id uuid, groups_id uuid, login uuid not null, users_login uuid unique, primary key (login));
...
alter table if exists students add constraint FKaipunbrrxko02lj9567rx25bp foreign key (groups_id) references groups;
